# Mastermind
This is a program to guess the code. The algorithm implemented in this file can reach about 13.33 times of guessing in average. You can find two python file. The '''Game.''' file is a breakdown explanation on playing one time game. The '''playing_1000''' file is to obtain the average number of guessing times after playing 1000 times. The result still need to be improved. 
## 1. About the game<br />
...
6. This function helps us to choose the element in the code set to play in the next run. This sepecific element we choose should clean more elements in the code set. Please refer to the paper "Eﬃcient solutions for Mastermind using genetic algorithms" page 8. 
